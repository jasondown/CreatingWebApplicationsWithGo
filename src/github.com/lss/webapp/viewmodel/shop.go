...
func NewShop() Shop {
	...
	juiceCategory := Category{
		...
		Description: `Explore our wide assortment of juice and mixes expected by
	...
	supplyCategory := Category{
		...
		Description: `From paper cups to bio-degradable platic to straws and
	...
	advertiseCategory := Category{
		...
		Description: `Sure, you could just wait for people to find your stand
						...
						level, check out our premium line of advertising supplies.`,
	}
